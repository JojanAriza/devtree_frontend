  ...
  return (
    <form onSubmit={handleSubmit(handleSearch)} className="space-y-5">
      ...
      <div className="mt-10">
        ...
        {mutation.data && <p className="text-center text-cyan-500 font-black">{mutation.data} ir a <Link to={'/auth/register'} state={{handle: slugify(handle)}}>Registrarse</Link></p>}
      </div>
