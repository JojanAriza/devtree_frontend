    ...
    <div className="space-y-6 text-white">
      ...
      <div className="mt-20 flex flex-col gap-6">
        {links.length ? links.map(link => (
            <a key={link.name} href={link.url} className="bg-white px-5 py-2 flex items-center gap-5 rounded-lg" target="_blank" rel="noreferrer noopener" //hacer una consulta sobre esta parte de seguridad
            >
